...
public class AcNotificacaoVencer extends AppCompatActivity {
    ...
    private PagarItensAdapter CarregaRecycler(){
        ...
        try{
            ArrayList<GrupoMesDto> meses =new PagoDal(this).BuscaListaVencer();

            ArrayList<PagarHeader> companies = new ArrayList<>();
            ArrayList<PagarItens> products;

            for (GrupoMesDto obj : meses){
                ArrayList<ContaDto> conta = new PagoDal(this).BuscaListaVencerItens(obj.MesAbreviado);
